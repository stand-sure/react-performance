...
const Globe = React.lazy(loadGlobeModule);

const GlobeSuspenseWrapper = ({showGlobe}) => (
  <React.Suspense fallback={<div>Loading...</div>}>
    <div style={{width: 400, height: 400}}>{showGlobe ? <Globe /> : null}</div>
  </React.Suspense>
);
...
function App() {
  ...
  return (
    ...
    >
      ...
      <GlobeSuspenseWrapper showGlobe={showGlobe} />
    </div>
  );
}
